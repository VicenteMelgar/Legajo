...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('documento', models.CharField(choices=[('R.A.', 'Resolución Administrativa'), ('R.D.', 'Resolución Directoral'), ('Memorando', 'Memorando')], max_length=50, verbose_name='Tipo de Documento')),
                ('numero', models.CharField(max_length=50, unique=True, verbose_name='Número')),
                ('tipo', models.CharField(blank=True, choices=[('Nombramiento', 'Nombramiento'), ('Contrato', 'Contrato'), ('Adenda', 'Adenda'), ('Asignación de Funciones', 'Asignación de Funciones'), ('Destaque de otra Dependencia', 'Destaque de otra Dependencia'), ('Renovación de Destaque de otra Dependencia', 'Renovación de Destaque de otra Dependencia'), ('Destaque a otra Dependencia', 'Destaque a otra Dependencia'), ('Designación de otra Dependencia', 'Designación de otra Dependencia'), ('Designación a otra Dependencia', 'Designación a otra Dependencia'), ('Rotación', 'Rotación'), ('Encargatura', 'Encargatura'), ('Renovación de Encargatura', 'Renovación de Encargatura'), ('Permuta', 'Permuta'), ('Ascenso', 'Ascenso'), ('Cambio de grupo Ocupacional', 'Cambio de grupo Ocupacional')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denominacion', models.CharField(choices=[('Oficina de Economía', 'Oficina de Economía'), ('Oficina de Logística', 'Oficina de Logística'), ('Oficina de Personal', 'Oficina de Personal')], max_length=100, verbose_name='Denominación')),
                ('fecha_inicio', models.DateField(verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Fecha de Finalización')),
                ('legajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.legajo')),
                ('vinculo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.vinculo')),
