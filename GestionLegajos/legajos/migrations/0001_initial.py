...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_documento', models.PositiveSmallIntegerField(choices=[(3, 'Resultado Final de proceso de selección'), (6, 'Informe de la Oficina de Personal')], verbose_name='Documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(upload_to='vinculo/', verbose_name='Cargar PDF')),
                ('cargo', models.ManyToManyField(blank=True, null=True, to='legajos.cargo')),
                ('empleado', models.ManyToManyField(to='legajos.datospersonales')),
                ('nivel', models.ManyToManyField(blank=True, null=True, to='legajos.nivel')),
                ('plaza', models.ManyToManyField(blank=True, null=True, to='legajos.plaza')),
            ],
            options={
