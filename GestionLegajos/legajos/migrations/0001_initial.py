# Generated by Django 5.1.3 on 2024-12-08 22:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(blank=True, choices=[('F', 'Femenino'), ('M', 'Masculino'), ('T', 'Travesti'), ('I', 'Fino')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalidade', models.ManyToManyField(blank=True, to='legajos.modalidad')),
