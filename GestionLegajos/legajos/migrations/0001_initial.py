...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('documento', models.CharField(blank=True, choices=[('R.A.', 'Resolución Administrativa'), ('R.D.', 'Resolución Directoral'), ('Memorando', 'Memorando')], max_length=100, null=True)),
                ('numero', models.CharField(max_length=50, unique=True, verbose_name='Número de Resolución')),
                ('tipo', models.CharField(choices=[('Nombramiento', 'Nombramiento'), ('Contrato', 'Contrato'), ('Adenda', 'Adenda'), ('Asignación de Funciones', 'Asignación de Funciones'), ('Destaque de otra Dependencia', 'Destaque de otra Dependencia'), ('Renovación de Destaque de otra Dependencia', 'Renovación de Destaque de otra Dependencia'), ('Destaque a otra Dependencia', 'Destaque a otra Dependencia'), ('Designación de otra Dependencia', 'Designación de otra Dependencia'), ('Designación a otra Dependencia', 'Designación a otra Dependencia'), ('Rotación', 'Rotación'), ('Encargatura', 'Encargatura'), ('Renovación de Encargatura', 'Renovación de Encargatura'), ('Permuta', 'Permuta'), ('Ascenso', 'Ascenso'), ('Cambio de grupo Ocupacional', 'Cambio de grupo Ocupacional'), ('Otro', 'Otro')], max_length=100)),
                ('otro', models.CharField(blank=True, max_length=1000, null=True, verbose_name='Otro Documento, Especificar:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('periodo', models.CharField(choices=[('I', 'I'), ('II', 'II')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('centro', models.CharField(blank=True, max_length=250, null=True, verbose_name='Centro de Estudios')),
                ('inicio', models.DateField()),
                ('fin', models.DateField()),
                ('grado_instruccion', models.PositiveSmallIntegerField(choices=[(10, 'Secundaria Completa'), (20, 'Superior Técnica Incompleta'), (30, 'Superior Técnica'), (40, 'Superior Universitario Incompleta'), (50, 'Superior Universitario'), (60, 'Maestría'), (70, 'Doctorado')], verbose_name='Grado de Instrucción')),
                ('especialidad', models.CharField(blank=True, max_length=50, null=True)),
                ('fecha_expedicion', models.DateField(blank=True, null=True)),
                ('colegiatura', models.CharField(blank=True, max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('documento', models.PositiveSmallIntegerField(choices=[('R.A.', 'Resolución Administrativa'), ('R.D.', 'Resolución Directoral'), ('Memorando', 'Memorando')], verbose_name='Tipo de Documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.empleado')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='OficinaHistorial',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denominacion', models.CharField(choices=[('Oficina de Economía', 'Oficina de Economía'), ('Oficina de Logística', 'Oficina de Logística'), ('Oficina de Personal', 'Oficina de Personal')], max_length=100, verbose_name='Departamento u Oficina')),
                ('fecha_inicio', models.DateField(blank=True, null=True, verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Fecha de Finalización')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.empleado')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denominacion', models.CharField(choices=[('CD-I', 'CD-I'), ('CD-V', 'CD-V'), ('ENF-10', 'ENF-10'), ('ENF-11', 'ENF-11'), ('ENF-12', 'ENF-12'), ('ENF-13', 'ENF-13'), ('ENF-14', 'ENF-14'), ('F-3', 'F-3'), ('F-4', 'F-4'), ('F-5', 'F-5'), ('G5-V', 'G5-V'), ('MC-1', 'MC-1'), ('MC-2', 'MC-2'), ('MC-3', 'MC-3'), ('MC-4', 'MC-4'), ('MC-5', 'MC-5'), ('OPS-IV', 'OPS-IV'), ('OPS-V', 'OPS-V'), ('OPS-VIII', 'OPS-VIII'), ('PS-IV', 'PS-IV'), ('PS-V', 'PS-V'), ('PS-VI', 'PS-VI'), ('PS-VII', 'PS-VII'), ('PS-VIII', 'PS-VIII'), ('SAA', 'SAA'), ('SAB', 'SAB'), ('SAC', 'SAC'), ('SAD', 'SAD'), ('SAF', 'SAF'), ('SPC', 'SPC'), ('SPD', 'SPD'), ('SPE', 'SPE'), ('SPF', 'SPF'), ('STA', 'STA'), ('STB', 'STB'), ('STC', 'STC'), ('STD', 'STD'), ('STE', 'STE'), ('STF', 'STF'), ('TM-1', 'TM-1'), ('TM-2', 'TM-2')], max_length=100, verbose_name='Denominación')),
                ('fecha_inicio', models.DateField(blank=True, null=True, verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Fecha de Finalización')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.empleado')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denominacion', models.CharField(choices=[('Auxiliares', 'Auxiliares'), ('Funcionarios y Directivos', 'Funcionarios y Directivos'), ('Profesionales', 'Profesionales'), ('Profesionales de la Salud', 'Profesionales de la Salud'), ('Tecnicos', 'Tecnicos')], max_length=100, verbose_name='Denominación')),
                ('fecha_inicio', models.DateField(blank=True, null=True, verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Fecha de Finalización')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.empleado')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
        ...
        migrations.CreateModel(
            name='CondicionHistorial',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denominacion', models.CharField(choices=[('Nombrado', 'Nombrado'), ('Contratado', 'Contratado a Plazo Fijo'), ('CAS', 'Contrato Administrativo de Servicios')], max_length=100, verbose_name='Denominación')),
                ('fecha_inicio', models.DateField(blank=True, null=True, verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Fecha de Finalización')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.empleado')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('Incorporación', 'Incorporación'), ('Progresión', 'Progresión'), ('Desplazamiento', 'Desplazamiento'), ('Desvinculación', 'Desvinculación')], max_length=100)),
                ('descripcion', models.CharField(blank=True, max_length=1000, verbose_name='Descripción')),
                ('legajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.legajo')),
                ('resolucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='legajos.resolucion', verbose_name='Resolución')),
            ],
            options={
